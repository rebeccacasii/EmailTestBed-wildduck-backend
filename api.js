...
// ETB
const companyRoutes = require('./lib/api/etb/company');
const personRoutes = require('./lib/api/etb/person');
const messageRoutes = require('./lib/api/etb/message');
const scriptRoutes = require('./lib/api/etb/script');
const flowRoutes = require('./lib/api/etb/flow');

// const ScriptHandler = require('./lib/api/etb/handler/scriptHandler');
...
module.exports = done => {
    ...
    // ETB
    companyRoutes(db, server);
    personRoutes(db, server);
    messageRoutes(db, server);
    scriptRoutes(db, server);
    flowRoutes(db, server);
